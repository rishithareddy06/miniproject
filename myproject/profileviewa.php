                        ...
                        <div class="12u$">
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="3u 12u$(large)">
                                        <a href="deleteproduct.php" class="btn btn-danger" style="text-decoration: none;">delete product</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="manageFarmers.php" class="btn btn-danger" style="text-decoration: none;">manage farmers</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="manageBuyers.php" class="btn btn-danger" style="text-decoration: none;">manage buyers</a>
                                    </div>
