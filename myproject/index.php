...
<html lang="en">
	...
	<?php require 'nav.php'; ?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Efarming &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">CNR Plaza<span>Hyderabad</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:abc@gmail.com" style="color:white">farm@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About EFarming</b></span>
				Efarming is e-commerce trading platform for grains & grocerries...
			</p>
